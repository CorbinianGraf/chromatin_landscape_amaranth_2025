...
INPUT=raw_data/Plainsman/IsoSeq/plainsman_renamed_flnc_polished.hq.fasta
...
CLUSTERREPORT=raw_data/Plainsman/IsoSeq/plainsman_flnc_polished.cluster_report.fixed_names.csv
